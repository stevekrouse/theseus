...
--Looking over my code, I realized how obfuscated it is. I appologize for
--that. I used a lot of maps and set differences and other tricky haskell moves,
--which was fun. However, I realized that I need to get better at writing
--cleaner code. Hopefully, I can get better at that next semester!
